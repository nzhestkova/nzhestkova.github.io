...
/* harmony import */ var _store_services_waiting_store_service_waiting_store_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./store/services/waiting-store.service/waiting-store.service */ "./src/app/store/services/waiting-store.service/waiting-store.service.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        providers: [
            ...
            _store_services_waiting_store_service_waiting_store_service__WEBPACK_IMPORTED_MODULE_18__["WaitingStoreService"],
        ],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".smooth-animation {\n  transition: all 500ms ease;\n}\n.font-set {\n  font-family: \"Georgia\", sans-serif;\n}\n.bold-text {\n  font-weight: bold;\n}\n.link {\n  color: #6455b2;\n  text-decoration: none;\n}\n.flex-grow {\n  flex-grow: 1;\n}\n.fixed-bottom {\n  position: fixed;\n  left: 0;\n  bottom: 0;\n  right: 0;\n}\n.padding {\n  padding: 20px;\n}\n.vertical-padding {\n  padding: 20px 0;\n}\n.vertical-small-padding {\n  padding: 10px 0;\n}\n.horizontal-padding {\n  padding: 0 20px;\n}\n.horizontal-small-padding {\n  padding: 0 10px;\n}\n.horizontal-right-padding {\n  padding: 0 20px 0 0;\n}\n.horizontal-auto-margin {\n  margin-left: auto;\n  margin-right: auto;\n}\n.horizontal-margin {\n  margin: 0 20px;\n}\n.horizontal-small-margin {\n  margin: 0 10px;\n}\n.horizontal-left-margin {\n  margin: 0 0 0 20px;\n}\n.horizontal-small-right-margin {\n  margin: auto 10px auto 0;\n}\n.horizontal-small-left-margin {\n  margin: auto 0 auto 10px;\n}\n.bottom-margin {\n  margin-bottom: 20px;\n}\n.vertical-margin {\n  margin: 20px 0;\n}\n.vertical-auto-margin {\n  margin-top: auto;\n  margin-bottom: auto;\n}\n.center-aligned {\n  margin: auto;\n}\n.right-aligned {\n  margin: auto 0 auto auto;\n}\n.left-aligned {\n  margin: 0 auto auto 0;\n}\n.column-display {\n  display: flex;\n  flex-direction: column;\n}\n.row-display {\n  display: flex;\n}\n.button {\n  font-family: \"Georgia\", sans-serif;\n  outline: none;\n  padding: 5px 10px;\n}\n.small-icon {\n  width: 1.3em;\n}\n.sign-in {\n  font-family: \"Georgia\", sans-serif;\n  outline: none;\n  padding: 5px 10px;\n  color: white;\n  background: #00a100;\n  border-color: #00a100;\n  border-left: none;\n}\n.sign-up {\n  font-family: \"Georgia\", sans-serif;\n  outline: none;\n  padding: 5px 10px;\n  background: #d7d7d7;\n  border-color: #d7d7d7;\n  border-right: none;\n}\n.relative-position {\n  position: relative;\n}\n.absolute-in-top-right {\n  position: absolute;\n  right: 0;\n  top: 0;\n}\n.background {\n  position: fixed;\n  left: 0;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  padding: 0.5em;\n  overflow-y: scroll;\n}\n.theme {\n  position: fixed;\n  width: 2.7em;\n  height: 2.7em;\n  left: 0.7em;\n  top: 0.7em;\n  border: 1px solid transparent;\n  border-radius: 100%;\n  outline: none;\n  z-index: 1;\n}\n.theme-icon {\n  line-height: 0.7em;\n  font-size: 1.2em;\n}\n.light-theme {\n  background: #e8e8e8;\n  color: #1a1a1a;\n  transition: all 500ms ease;\n}\n.light-theme-button {\n  background: #1f2123;\n  box-shadow: 0 0 0.5em #1f2123;\n  transition: all 500ms ease;\n}\n.light-theme-button:hover {\n  background: #131415;\n  box-shadow: 0 0 1em #000000;\n}\n.dark-theme {\n  background: #2b2e30;\n  color: white;\n  transition: all 500ms ease;\n}\n.dark-theme-button {\n  background: #f5f5f5;\n  box-shadow: 0 0 0.5em #cfcfcf;\n  transition: all 500ms ease;\n}\n.dark-theme-button:hover {\n  background: #ffffff;\n  box-shadow: 0 0 1em #e8e8e8;\n}\n.window-light-theme {\n  background: #ffffff;\n  box-shadow: 0 0 10px rgba(0, 0, 0, 0.15);\n  color: #1a1a1a;\n  transition: all 500ms ease;\n}\n.window-dark-theme {\n  background: #626262;\n  box-shadow: 0 0 10px rgba(0, 0, 0, 0.26);\n  color: white;\n  transition: all 500ms ease;\n}\n::-webkit-scrollbar {\n  width: 0;\n}\n.load-popup {\n  display: flex;\n  flex-direction: column;\n  position: fixed;\n  top: 0;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  transition: all 500ms ease;\n}\n.load-icon {\n  padding: 20px 30px;\n  border-radius: 30px;\n  transition: all 500ms ease;\n}\n.load-image {\n  margin: auto;\n  min-width: 30px;\n  max-width: 85px;\n  transition: all 500ms ease;\n}\n.load-phrase {\n  font-size: 18px;\n  font-weight: bold;\n  padding-top: 10px;\n}\n.popup-transparent-light {\n  background: rgba(213, 213, 213, 0.7);\n}\n.popup-transparent-dark {\n  background: rgba(91, 91, 91, 0.7);\n}\n.load-icon-transparent-light {\n  background: rgba(249, 249, 249, 0.7);\n}\n.load-icon-transparent-dark {\n  background: rgba(63, 63, 63, 0.7);\n}\n.load-phrase-text-light {\n  color: #1e0456;\n}\n.load-phrase-text-dark {\n  color: #cad6ff;\n}\n.status-dark-theme {\n  color: #532478;\n  background: #f9f9f9;\n  transition: all 500ms ease;\n}\n.status-light-theme {\n  color: white;\n  background: #5f508d;\n  transition: all 500ms ease;\n}\n.plate {\n  font-family: \"Georgia\", sans-serif;\n  width: 45%;\n  margin-left: 10px;\n  padding: 20px 10px;\n  border-radius: 5px;\n  max-width: 140px;\n}\n.status {\n  text-align: center;\n  font-weight: bold;\n  max-width: 120px;\n  padding: 5px 20px;\n  border-radius: 5px;\n}\n.user-data {\n  margin-top: 20px;\n}\n.user-data-ico {\n  width: 120px;\n  margin: 10px auto;\n  padding: 10px;\n}\n.user-data-username {\n  text-align: center;\n  max-width: 120px;\n  margin-top: 10px;\n  font-weight: bold;\n  line-height: 1.5;\n}\n.message {\n  margin-top: 20px;\n  padding-left: 10px;\n  text-align: left;\n  font-weight: bold;\n}\n.part {\n  font-weight: lighter;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */");
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _store_services_theme_store_service_theme_store_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../store/services/theme-store.service/theme-store.service */ "./src/app/store/services/theme-store.service/theme-store.service.ts");
/* harmony import */ var _store_services_user_store_service_user_store_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../store/services/user-store.service/user-store.service */ "./src/app/store/services/user-store.service/user-store.service.ts");
...
let ProfileComponent = class ProfileComponent {
    constructor(userStore, themeStore, router, cdr) {
        this.userStore = userStore;
        this.themeStore = themeStore;
        this.router = router;
        this.cdr = cdr;
