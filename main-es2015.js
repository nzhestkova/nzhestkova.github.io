...
let NotificationsComponent = class NotificationsComponent {
    constructor(userService, userStore, cdr) {
        this.userService = userService;
        this.userStore = userStore;
        this.cdr = cdr;
    }
...
const welcomeNotification = new Notification(_messages__WEBPACK_IMPORTED_MODULE_1__["messages"].welcomeMessage, "welcome", 60 * 60 * 1000);
...
let UserService = class UserService {
    ...
    saveUserInfo() {
        ...
        return this._http.put(this.usersURL + `${this.userInfo._id}`, this.userInfo).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(() => true), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])((err) => Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(err)));
    }
    forCheck() {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "markNotificationsAsChecked", function() { return markNotificationsAsChecked; });
...
const markNotificationsAsChecked = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])(notificationCHECKED);
