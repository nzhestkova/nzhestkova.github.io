...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
      ...
      _createClass(HomePageComponent, [{
        ...
        value: function ngDoCheck() {
          ...
          this.subscriber = this.userStore.loadUserInfo().subscribe(function (user) {
            _this7.user = user;
            _this7.userExist = !!Object.keys(user).length;
  ...
  function srcAppComponentsNotificationsNotificationsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var NotificationsComponent = /*#__PURE__*/function () {
      function NotificationsComponent(userStore, cdr) {
      ...
      _createClass(ProfileComponent, [{
        ...
        value: function deleteUser(value) {
          ...
          this.userService.deleteAccount(this.user._id).subscribe(function (answer) {
            if (answer) {
              _this10.userStore.logout();

              _this10.router.navigate([""]).then();
            }
          });
        }
      }, {
        ...
        value: function ngDoCheck() {
          ...
          this.themeStore.loadThemeInfo().subscribe(function (theme) {
            return _this11.darkTheme = theme;
          });
          this.subscriber = this.userStore.loadUserInfo().subscribe(function (user) {
            _this11.userExist = !!Object.keys(user).length;
            _this11.user = user;
      ...
      _createClass(SignInFormComponent, [{
        ...
        value: function submitForm() {
          ...
          this.userService.loginUser(login, password).subscribe(function (data) {
            ...
            _this12.authErrors.getError = true;

            if (error.status === 404) {
              _this12.authErrors.loginDoesntExist = true;
              _this12.authErrors.passwordDoesntMatch = false;
            }

            if (error.status === 502) {
              _this12.authErrors.loginDoesntExist = false;
              _this12.authErrors.passwordDoesntMatch = true;
            }
      ...
      _createClass(SignUpFormComponent, [{
        ...
        value: function submitForm() {
          ...
          this.userService.registerNewUser(newUser).subscribe(function (data) {
            ...
            return _this14.waitingStore.deactivateLoading();
          });
        }
      }, {
        key: "controlStatus",
        ...
        value: function checkLogin() {
          ...
          this.userService.checkLogin(this.registerForm.get("login").value).subscribe(function () {
            {
              _this15.loginCheckStatus.pending = false;
              _this15.loginCheckStatus.exist = true;
              _this15.loginCheckStatus.free = false;

              _this15.cdr.markForCheck();
            }
          }, function () {
            _this15.loginCheckStatus.pending = false;
            _this15.loginCheckStatus.exist = false;
            _this15.loginCheckStatus.free = true;
  ...
  function srcAppModelNotificationTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var welcomeNotification = new Notification(_messages__WEBPACK_IMPORTED_MODULE_1__["messages"].welcomeMessage, "welcome", 60 * 1000);
    /***/
  },
