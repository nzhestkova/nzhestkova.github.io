      ...
      _createClass(ProfileComponent, [{
        ...
        value: function deleteUser(value) {
          ...
          this.userService.deleteAccount(this.user._id).subscribe(function (answer) {
            if (answer) {
              _this9.userStore.logout();

              _this9.router.navigate([""]).then();
            }
          });
        }
      }, {
        ...
        value: function ngDoCheck() {
          ...
          this.themeStore.loadThemeInfo().subscribe(function (theme) {
            return _this10.darkTheme = theme;
          });
          this.subscriber = this.userStore.loadUserInfo().subscribe(function (user) {
            _this10.userExist = !!Object.keys(user).length;
            _this10.user = user;
      ...
      _createClass(SignInFormComponent, [{
        ...
        value: function submitForm() {
          ...
          this.userService.loginUser(login, password).subscribe(function (data) {
            _this11.userStore.loginUser(data);

            _this11.cookieService.saveLogin(data.login);

            _this11.cookieService.savePassword(data.password);

            _this11.waitingStore.deactivateLoading();

            _this11.router.navigate(["", "profile"]).then();
          }, function (error) {
            _this11.authErrors.getError = true;

            if (error.status === 404) {
              _this11.authErrors.loginDoesntExist = true;
              _this11.authErrors.passwordDoesntMatch = false;
            }

            if (error.status === 502) {
              _this11.authErrors.loginDoesntExist = false;
              _this11.authErrors.passwordDoesntMatch = true;
            }
      ...
      _createClass(SignUpFormComponent, [{
        ...
        value: function submitForm() {
          ...
          this.userService.registerNewUser(newUser).subscribe(function (data) {
            ...
            return _this13.waitingStore.deactivateLoading();
          });
        }
      }, {
        key: "controlStatus",
        ...
        value: function checkLogin() {
          ...
          this.userService.checkLogin(this.registerForm.get("login").value).subscribe(function () {
            {
              _this14.loginCheckStatus.pending = false;
              _this14.loginCheckStatus.exist = true;
              _this14.loginCheckStatus.free = false;

              _this14.cdr.markForCheck();
            }
          }, function () {
            _this14.loginCheckStatus.pending = false;
            _this14.loginCheckStatus.exist = false;
            _this14.loginCheckStatus.free = true;
